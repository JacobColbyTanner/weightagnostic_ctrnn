...
from fitnessFunction_vehicle_robust import fitnessFunction_vehicle_robust
...
evol_params = {
    ...
    "fitness_function": lambda x: fitnessFunction_vehicle_robust(
        x, ctrnn_size, ctrnn_step_size, bv_duration, bv_distance, bv_step_size, transient_steps, robust_range, discrete=discrete
...
for i in range(100):
    ...
    with open("best_individual_robust", "wb") as f:
