...
class Agent:
    ...
    def __init__(self):
        ...
        self.s1x = self.r * np.cos(self.o + self.a)     # sensor 2 x position
        self.s1y = self.r * np.sin(self.o + self.a)     # sensor 2 y position
        self.s2x = self.r * np.cos(self.o - self.a)     # sensor 3 x position
        self.s2y = self.r * np.sin(self.o - self.a)     # sensor 3 y position
